            ...
            <div class="col-md-12">
              <div class="box box-info">
                ...
                <div class="box-body pad">
                  <form method="post" action="{{ url('/admin/update_post') }}/<?php echo $post->id; ?>" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="date" name="publish_date" class="form-control" placeholder="Publish Date" value="<?php echo $post->publish_date; ?>" required>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="hashtags" class="form-control" placeholder="Hashtags" value="<?php echo $post->hashtags; ?>" required>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select name="status" class="form-control" required>
                            ...
                            <option value="To Do" <?php if($post->status == 'To Do'){ echo 'selected'; } ?> >To Do</option>
                            <option value="Active" <?php if($post->status == 'Active'){ echo 'selected'; } ?> >Active</option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <textarea name="post_text" class="form-control" placeholder="Post Description" id = "editor1" required><?php echo $post->post_text; ?></textarea>
                        </div>
                      </div>
                    </div>
